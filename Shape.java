...
public class Shape extends JComponent{
	...
	public static void shape(int n, double x, double y, double width, double height) {
		...
		rectangles.add(new Rectangle2D.Double(x, y, width, height));
                ...
                shape(n-1,x-(newWidth/2)+width ,y-(newHeight/2), newWidth,newHeight);
                shape(n-1,x-(newWidth/2)+width,y-(newHeight/2)+height,newWidth,newHeight);
                shape(n-1,x-(newWidth/2),y-(newHeight/2)+height,newWidth,newHeight);
